...
public class Contacts1 {
    ...
    /*
     * NOTE : ================================================================== These messages
     * shown to the user are defined in one place for convenient editing and proof reading. Such
     * messages are considered part of the UI and may be subjected to review by UI experts or
     * technical writers. Note that Some of the strings below include '%1$s' etc to mark the
    ...
    private static final String MESSAGE_DISPLAY_PERSON_DATA =
            "%1$s  Phone Number: %2$s  Email: %3$s";
    ...
    private static final String COMMAND_ADD_PARAMETERS = "NAME " + PERSON_DATA_PREFIX_PHONE
    ...
    /*
     * We use a String array to store details of a single person. The constants given below are the
     * indexes for the different data elements of a person used by the internal String[] storage
     * format. For example, a person's name is stored as the 0th element in the array.
     */
    ...
    /*
     * This variable is declared for the whole class (instead of declaring it inside the
     * readUserCommand() method to facilitate automated testing using the I/O redirection technique.
    ...
    /*
     * NOTE : ============================================================= Notice how this method
     * solves the whole problem at a very high level. We can understand the high-level logic of the
     * program by reading this method alone. If the reader wants a deeper understanding of the
     * solution, she can go to the next level of abstraction by reading the methods that are
     * referenced by the high-level method below.
     * ====================================================================
     */

    /**
     * Main entry point of the application. Initializes the application and starts the interaction
     * with the user.
     */
     ...
     * comment can be omitted if the method is trivial and the header comment is going to be almost
     * identical to the method signature anyway.
     * ====================================================================
     */
     ...
     * can be omitted from the method header comment if the parameter name is self-explanatory. In
     * the method below, '@param userInput' comment has been omitted.
     * ====================================================================
     */
    ...
    /**
     * Adds a person (specified by the command args) to the address book. The entire command
     * arguments string is treated as a string representation of the person to add.
     *
    ...
    /*
     * NOTE : ============================================================= Note how the method
     * below uses Java 'Varargs' feature so that the method can accept a varying number of message
     * parameters. ====================================================================
     */
    ...
    private static String getDisplayString(String[][] persons) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            messageAccumulator.append('\t')
                    .append(getIndexedPersonListElementMessage(displayIndex, person)).append(LS);
        }
    ...
    /**
     * Returns true if person data (email, name, phone etc) can be extracted from the argument
     * string. Format is [name] p/[phone] e/[email], phone and email positions can be swapped.
     *
    ...
    private static String getUsageInfoForAllCommands() {
        return getUsageInfoForAddCommand() + LS + getUsageInfoForViewCommand() + LS
